package com.example.mysdk.util.toolUtils;
...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(com.example.mysdk.util.toolUtils.Utils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(com.example.mysdk.util.toolUtils.Utils.getApp().getPackageManager()) == null ||
                com.example.mysdk.util.toolUtils.Utils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(com.example.mysdk.util.toolUtils.Utils.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String pkg) {
        ...
        PackageManager pm = com.example.mysdk.util.toolUtils.Utils.getApp().getPackageManager();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(com.example.mysdk.util.toolUtils.Utils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(com.example.mysdk.util.toolUtils.Utils.getApp(), clz));
    }
